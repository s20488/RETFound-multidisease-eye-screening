...
csv_file_path = 'C:/Users/Anastasiia/Desktop/results/finetune_Kaggle/_metrics_val.csv'
txt_file_path = 'C:/Users/Anastasiia/Desktop/results/finetune_Kaggle/output_dir/log.txt'
...
plt.savefig('Kaggle_loss_comparison.png', dpi=300)
plt.show()