...
base_dir = 'C:/Users/Anastasiia/Desktop/Praca_dyplomowa/Praktyka/datasets/ADAM'
...
plt.legend(
    title="Kategorie",
    labels=["Zwyrodnienie plamki żółtej (ADM)", "Brak chorób"],
    loc="upper right"
)

plt.savefig('dystrybucja_zbioru_danych_ADAM.png', dpi=300)
plt.show()
plt.close()
