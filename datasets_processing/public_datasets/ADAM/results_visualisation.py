...
csv_file_path = 'C:/Users/Anastasiia/Desktop/results/finetune_ADAM/_metrics_val.csv'
txt_file_path = 'C:/Users/Anastasiia/Desktop/results/finetune_ADAM/output_dir/log.txt'
...
plt.savefig('ADAM_loss_comparison.png', dpi=300)
plt.show()
