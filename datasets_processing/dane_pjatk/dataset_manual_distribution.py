...
classes_file_path = "/mnt/data/manual_hypertension_distribution_strict2.csv"  # Обновите путь к вашему файлу

# Путь к исходным изображениям
source_images_path = "/mnt/data/cfi"

# Путь для сохранения изображений по наборам данных
target_path = "/mnt/data/cfi_manual_hypertension_strict2"
